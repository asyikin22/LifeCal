<!-- <style>
  .animated-bg {
    ...
    height: 100%;
    z-index: -1;
    background: rgb(236, 91, 166);
    animation: pulse 5s ease-in-out infinite;
  }

  @keyframes pulse {
    0%   { background: rgb(52, 152, 219); }   /* Soft Blue */
    50%  { background: rgb(46, 204, 113); }   /* Fresh Green */
    100% { background: rgb(155, 89, 182); }   /* Violet-Purple */
  }
...
<!-- <script>
  ...
  onMount(() => {
    ...
    for (let i = 0; i < particlesCount; i++) {
      ...
      const branch = (i % 5) * (2 * Math.PI / 5); // Spiral arms
